...
ax.bar(bar_numbers, values110, width=0.5, color='slategrey', label='10')
ax.bar(bar_numbers, values19, width=0.5, color='magenta', label='9')
ax.bar(bar_numbers, values18, width=0.5, color='saddlebrown', label='8')
ax.bar(bar_numbers, values17, width=0.5, color='blueviolet', label='7')
ax.bar(bar_numbers, values16, width=0.5, color='red', label='6')
ax.bar(bar_numbers, values15, width=0.5, color='green', label='5')
ax.bar(bar_numbers, values14, width=0.5, color='orange', label='4')
ax.bar(bar_numbers, values13, width=0.5, color='dodgerblue', label='3')
